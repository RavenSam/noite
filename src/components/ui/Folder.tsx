...
const EmptyFolders = () => {
   return (
      <div class="flex items-center flex-col space-y-8 justify-center min-h-[40vh]">
         <h2 class="font-semibold text-xl opacity-60">
               ...
               <For each={store.folders}>
                  {(folder) => (
                     <div
                        ...
                        class="relative overflow-hidden rounded-xl relative group flex flex-col items-center p-4 group hover:shadow-xl"
                     >
                        <div class="absolute inset-0 -z-10 bg-[var(--hope-colors-primary)] opacity-0 group-hover:opacity-10 backdrop-blur-md" />
